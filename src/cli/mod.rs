...
use crate::embrfs::{
    ...
    save_sub_engrams_dir_with_options, DirectorySubEngramStore, EmbrFS, HierarchicalQueryBounds,
};
...
pub fn run() -> io::Result<()> {
    ...
    match cli.command {
        ...
        Commands::Mount {
            ...
            let fuse_fs =
                EngramFS::from_engram(engram_data, manifest_data, config, DEFAULT_CHUNK_SIZE, true);

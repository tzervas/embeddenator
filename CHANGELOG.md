...
### Backlog (Infrastructure-Dependent)
- ARM64 CI validation and auto-trigger (TASK-004/TASK-005)

## [0.19.3] - 2026-01-02

### 🎉 Stable Pre-1.0 Milestone

This release marks a stable pre-1.0 milestone of Embeddenator with complete core features and comprehensive testing.
...
[0.19.3]: https://github.com/tzervas/embeddenator/releases/tag/v0.19.3
